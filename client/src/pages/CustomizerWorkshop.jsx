...
import ServiceModal from "../components/serviceModalCust";
...
export default function CustomizerWorkshop() {
    ...
    const getCustomizerDetails = async () => {
        try {
            const { data } = await axios.get('/customizerProfile');
            setCustomizerDetails(data);
            setLoading(false);
        } catch (error) {
            console.error('Error fetching customizer details:', error);
        }
    };
    ...
    const renderDashboard = () => (
        <>
            ...
            <div className="products-grid">
                ...
                <h1 style={{ color: 'white', fontSize: '32px' }}>Your Schedule</h1>
                <div>
